...
const SurveyCard = () => {
  ...
  return (
    <section className="w-full h-auto bg-[#ff862b] text-white 2xs:px-4 xs:px-2 2sm:px-4 px-10 2xs:py-4 xs:py-6 2sm:py-6 py-8 lg:py-12">
      <div className="flex flex-col 2xs:gap-2 gap-3 sm:gap-4 lg:gap-6 m-auto text-center items-center justify-center">
        <p className="tip-text 2xs:text-[20px] text-[24px] lg:text-[28px] font-extrabold text-[#ffeebe]">
        ...
        <div className="2xs:text-[10px] xs:text-sm 2sm:text-sm">
          ...
          >
            <button className="ml-2 w-auto h-auto px-3 py-2 bg-white text-[#ff862b] rounded-md font-extrabold">
        ...
        <div className="mt-3 2xs:text-[8px] xs:text-[10px] 2sm:text-[10px] sm:text-[14px]">
          ...
          <span className="text-[#ffeebe] font-semibold">
